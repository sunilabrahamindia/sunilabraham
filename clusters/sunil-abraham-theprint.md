...
***ThePrint*** is an Indian digital news platform covering politics, policy, governance, and technology. Some of its reporting on digital policy and platform regulation includes commentary from **Sunil Abraham**, particularly in discussions around privacy, data governance, and emerging technology policy.

This cluster brings together relevant media mentions from *ThePrint*, allowing readers to locate these reports in one place.
...
## External links
- [Sunil Abraham](https://theprint.in/?s=Sunil+Abraham) search results on *ThePrint*
