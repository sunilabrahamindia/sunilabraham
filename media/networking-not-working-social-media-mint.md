...
description: "A Mint feature by Shreya Ray on the growing trend of social networking refuseniks, with Sunil Abraham on the technology hype cycle and why leaving Facebook is harder than it looks."
...
**Networking? Not Working** is a *Mint* feature by Shreya Ray published on 13 July 2010. The piece profiles a generation of social networking "refuseniks" and explores their reasons for deleting their Facebook, Orkut and MySpace accounts: wasted time, trivialised communication, and mounting privacy concerns. Sunil Abraham provides an analytical framework, describing the phenomenon as a predictable stage in the technology hype cycle, while noting that the network effect makes it structurally difficult to actually leave.
...
<dl class="media-details">
  ...
  <dd>
    <a class="btn" href="https://www.livemint.com/Leisure/TsGqblOuRdQtrqY3erzC3H/Networking-Not-working.html">
      Read Online
    </a>
  </dd>
</dl>
...
<p><em>Varuni Khosla contributed to this story.</em></p>
...
This article appeared in July 2010, when Facebook had just crossed 450 million users globally and was simultaneously facing the sharpest privacy backlash it had encountered to that point. In May 2010, the "Quit Facebook Day" campaign had drawn roughly 30,000 participants — a small number in absolute terms, but one that attracted significant media coverage and contributed to Zuckerberg's decision to hold a public press conference on privacy. The timing also coincided with a period of rapid growth in the Indian user base, which meant that the tensions the article describes — between the connective utility of a platform and its cost to time, attention and personal data — were newly relevant to an Indian readership.

Sunil Abraham's contribution is analytical rather than polemical. His invocation of the "hype cycle" — a concept drawn from Gartner's technology adoption curve — places the refusenik phenomenon within a predictable sequence: adoption, over-enthusiasm, disillusionment, and either stabilisation or abandonment. His point is that social networks face a structural tension: their value comes from aggregating large numbers of people, but that very aggregation erodes the exclusivity and intimacy that made them attractive in the first place. Once parents, colleagues and distant acquaintances are present, the network functions less as a social space and more as a monitored public square, creating a self-censorship dynamic that drives away the early adopters who gave it its initial character.

This was an early formulation of what would become a central theme in debates about social media over the following decade — that the commercial incentives driving platform growth are structurally in conflict with the social and expressive needs of the users those platforms depend on. The article captures that tension at a moment when it was first becoming visible, using the voices of ordinary users alongside an expert framework to give the phenomenon both human texture and analytical depth.

## External Link

- [Read on Mint](https://www.livemint.com/Leisure/TsGqblOuRdQtrqY3erzC3H/Networking-Not-working.html)
