---
layout: default
title: "Govt Wants to Scrub the Internet Clean"
description: "A Mint news report by Surabhi Agarwal and Leslie D'Monte on Kapil Sibal's push to pre-screen online content, with Sunil Abraham calling it unconstitutional and technically impossible."
...
**Govt Wants to Scrub the Internet Clean** is a *Mint* news report by Surabhi Agarwal and Leslie D'Monte published on 7 December 2011. The piece covers communications minister Kapil Sibal's announcement that the government would "evolve guidelines" to compel Google, Facebook, Microsoft and Yahoo to pre-screen and remove online content deemed offensive or blasphemous — a move triggered by the companies' refusal to comply with earlier government requests. [Sunil Abraham](/sunil/) is unequivocal: the proposed pre-screening regime is unconstitutional, technically impossible and would kill freedom of expression in India.
...
<dl class="media-details">
  ...
  <dt>👤 Authors:</dt>
  <dd>Surabhi Agarwal; Leslie D'Monte</dd>
  ...
  <dd>
    <a class="btn" href="https://www.livemint.com/Politics/RpHxWHOLrigsyLYmqH7P9J/Govt-wants-to-scrub-the-Internet-clean.html">
      Read Online
    </a>
  </dd>
</dl>
...
<p>New Delhi/Mumbai: India, the world's largest democracy, may force companies such as Google Inc., Microsoft Corp., Yahoo Inc. and Facebook Inc. to take down online content that it deems offensive because they haven't been able to come up with an effective self-censorship mechanism governing millions of users.</p>
...
This article appeared on 7 December 2011, immediately following Sibal's public remarks on the need to evolve guidelines for online content regulation — one of the most politically consequential moments in Indian Internet policy up to that point. The immediate trigger, as local media had reported, was a set of online posts critical of senior Congress leaders including party president Sonia Gandhi. Sibal did not name the posts at his briefing, but his framing — "blasphemous content", "against our cultural ethos", content that "affects the sensibility of our people" — was broad enough to encompass almost any material that the government found politically inconvenient. The episode was significant precisely because the demand was for pre-screening rather than post-publication takedown: Sibal was asking the platforms to build a filtering layer before content went live, not to respond to complaints after the fact.

The distinction matters enormously, and Abraham's quote makes it with precision. A post-publication takedown regime at least theoretically limits censorship to content that has already been identified and complained about; a pre-screening regime would require platforms to review every piece of user-generated content before publishing it, which is both technically unworkable at scale and structurally incompatible with how the Internet operates. Abraham's additional point — that companies would "err on the side of caution in a bid to please the government" — identifies the chilling effect mechanism: even if the government never formally ordered any specific removal, the existence of a pre-screening obligation would cause platforms to over-remove content systematically, with no judicial involvement and no transparency.

The political context gives the story a further dimension. By December 2011, the UPA government was under serious pressure: the 2G spectrum scam, the Commonwealth Games corruption controversy and Anna Hazare's anti-corruption campaign had all damaged the Congress party's standing. The Hazare movement had used social media effectively, and there is a reasonable argument — implicit in the article's second paragraph — that the government's appetite for Internet content controls was sharpened by its experience of online political mobilisation being used against it. Sibal's proposal triggered a significant domestic and international backlash and produced a sustained public debate about Internet regulation in India that shaped the terms of discussion for the rest of the decade.

## External Link

- [Read on Mint](https://www.livemint.com/Politics/RpHxWHOLrigsyLYmqH7P9J/Govt-wants-to-scrub-the-Internet-clean.html)
