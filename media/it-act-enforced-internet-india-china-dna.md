---
layout: default
title: "IT Act if Enforced Will Leave Internet Use in India No Freer Than in China"
description: "A DNA report examining how proposed IT Act rules could expand censorship powers, shift liability to intermediaries, and narrow the scope of online free expression in India."
...
**IT Act if Enforced Will Leave Internet Use in India No Freer Than in China** is a *DNA India* article published on 14 May 2011 by R Krishna. The report examines regulatory changes under the Information Technology Act that granted sweeping censorship powers to intermediaries and government authorities, raising concerns about freedom of expression online in India.
...
This article appeared during a period of significant regulatory change affecting internet freedom in India. On 11 April 2011, the Ministry of Communications and Information Technology notified the Information Technology (Intermediaries Guidelines) Rules, 2011 under Section 79 of the IT Act, 2000. These rules required intermediaries to remove content within 36 hours of receiving complaints, without providing clear mechanisms for appeal or judicial review.

The Centre for Internet and Society had filed a Right to Information request with the Department of Information Technology in May 2011, obtaining the first public disclosure of websites blocked by the government. The list revealed 11 blocked websites, though this represented only a fraction of actual blocks implemented across various departments and internet service providers. Most blocks were implemented following low-level court orders issued ex parte, meaning the affected website operators had no opportunity to present their case.

Freedom House's 2011 report on internet freedom classified India as "partly free" and ranked the country 14th out of the 37 countries surveyed. The report highlighted growing pressure on intermediaries, administrative censorship orders, and expanded government authority to block online content.

Critics pointed out that the rules created obligations beyond those found in existing constitutional and statutory frameworks. Terms such as "disparaging", "harassing", and "blasphemous" were included as grounds for content removal, despite the absence of corresponding legal definitions or established judicial precedents in Indian law. The "blasphemy" provision proved particularly contentious given that India had no blasphemy statute at the time.

The regulations reversed traditional legal presumptions by requiring intermediaries to remove content first and seek judicial relief later, rather than requiring complainants to obtain court orders before demanding removal. This structure created incentives for strategic abuse, as individuals or organisations could suppress unfavourable content through mere allegations without demonstrating actual legal violations.

The Zone-H.org case illustrated these concerns. The website was blocked following an ex parte interim order in a private commercial dispute between E2 Labs and Zone-H. The blocking extended to BloggerNews.net pages covering the case, and the affected parties received no notification of the blocks. Such incidents demonstrated how civil disputes could trigger government-enforced censorship without meaningful oversight.

## External Link

- [Read on DNA India](https://www.dnaindia.com/lifestyle/report-it-act-if-enforced-will-leave-internet-use-in-india-no-freer-than-in-china-1543284)
