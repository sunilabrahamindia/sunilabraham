---
layout: default
title: "Bangalore-Based NGO Files RTI Query Asking List of Websites Blocked by Indian Govt"
description: "A DNA India report on CIS filing an RTI query with India's Department of Information Technology, obtaining a first-ever public list of 11 blocked websites."
...
**Bangalore-Based NGO Files RTI Query Asking List of Websites Blocked by Indian Govt** is a *DNA India* article published on 18 May 2011, written by R Krishna. The report covers the Centre for Internet and Society's RTI application to the Department of Information Technology, which yielded the first publicly disclosed list of websites blocked by the Indian government. [Sunil Abraham](/sunil/), then executive director of CIS, noted that the information was not comprehensive and that the organisation planned to file further RTI applications to uncover who had ordered the blocks. The article also examines the broader implications of the IT (Intermediary Guidelines) Rules, 2011.
...
<dl class="media-details">
  ...
  <dd>
    <a class="btn" href="https://www.dnaindia.com/bangalore/report-bangalore-based-ngo-files-rti-query-asking-list-of-websites-blocked-by-indian-govt-1544647">
      Read Online
    </a>
  </dd>
</dl>
...
<p><em>Last month, the government quietly passed a new set of rules to regulate the Internet. The rules, adopted under the IT Act, give sweeping censorship powers and even have a provision against blasphemy — when India doesn't even have a blasphemy law. If enforced, the Internet will be no freer in India than it is in totalitarian China.</em></p>

<hr class="article-separator">

<p>The Centre for Internet &amp; Society (CIS), a Bangalore-based NGO, recently filed an RTI query with the Department of Information Technology (DIT), asking for a list of websites blocked by the Indian government under the IT Act. The department handed them a list of 11 websites. It was just one department's list, but this was the first time such a list was being made public. "The information given was not comprehensive. For instance, we still don't know who ordered these blocks," says Sunil Abraham, executive director, CIS, "We will file another RTI application to get those details out."</p>
...
The article appeared shortly after the Indian government notified the Information Technology (Intermediary Guidelines) Rules, 2011, under Section 79 of the IT Act. These rules placed significant takedown obligations on online intermediaries, requiring them to act on complaints within 36 hours, and drew criticism for vague, broadly worded categories of prohibited content.

The CIS's RTI filing was among the earliest efforts to bring transparency to India's website-blocking regime. At the time, no statutory mechanism required the government to disclose which sites were blocked or on whose authority, making the DIT's disclosure of 11 blocked sites a notable, if partial, step.

The debate over intermediary liability that this article captures prefigured later legislative and judicial developments in India, including the amendments to the IT (Intermediary Guidelines) Rules in 2021 and the subsequent court battles over content regulation and platform accountability.

## External Link

- [Read on DNA India](https://www.dnaindia.com/bangalore/report-bangalore-based-ngo-files-rti-query-asking-list-of-websites-blocked-by-indian-govt-1544647)
