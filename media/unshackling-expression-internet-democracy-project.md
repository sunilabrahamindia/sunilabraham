...
description: "The India chapter of APC's GISWatch special issue, authored by the Internet Democracy Project, mapping laws that criminalise online expression in India as of 2017."
...
4. [Chapter Overview](#chapter-overview)
5. [Sunil Abraham's Cited Contribution](#sunil-abrahams-cited-contribution)
6. [Context and Background](#context-and-background)
...
<dl class="media-details">
  <dt>📰 Published in:</dt>
  <dd><em>Internet Democracy Project</em> (India chapter of APC GISWatch special issue)</dd>

  <dt>📅 Date:</dt>
  <dd>16 March 2018</dd>

  <dt>👤 Authors:</dt>
  <dd>Anja Kovacs &amp; Nayantara Ranganathan</dd>

  <dt>📄 Type:</dt>
  <dd>Research Report (Book Chapter)</dd>

  <dt>🔗 Publication Link:</dt>
  <dd>
    <a class="btn" href="https://internetdemocracy.in/reports/unshackling-expression-a-study-on-laws-criminalising-expression-online-in-asia/">
      Read Online (India Chapter)
    </a>
  </dd>

  <dt>🔗 Full Report (PDF):</dt>
  <dd>
    <a class="btn" href="https://www.giswatch.org/sites/default/files/giswspecial2017_web.pdf">
