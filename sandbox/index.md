    ...
    <div className="w-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white p-8 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-blue-200 text-lg">Critical Insights from Sunil Abraham's ORF Analysis (July 2020)</p>
          <p className="text-sm text-blue-300 mt-2">Beyond the Success Story: Governance Gaps & Strategic Tensions</p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed">
                ...
                <span className="font-bold text-yellow-300"> Google Pay and Walmart's PhonePe dominate 80%+ of the market </span>
          ...
          <div className="bg-slate-800/60 backdrop-blur border border-orange-500/30 rounded-xl p-6">
            ...
            <div className="space-y-3 text-sm">
              <p className="bg-slate-700/50 p-3 rounded border-l-4 border-yellow-500">
                ...
                UPI is evangelised as “open” but specifications remain proprietary.
              </p>
              <p className="bg-slate-700/50 p-3 rounded border-l-4 border-orange-500">
                ...
                UPI 2.0 fixed vulnerabilities, but updated standards remain unpublished.
              </p>
              <p className="text-gray-300 italic">
                Violates India’s own FOSS policies and undermines true digital sovereignty.
              </p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-purple-900/40 to-blue-900/40 border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <div className="bg-slate-800/60 p-4 rounded">
              ...
              <div className="text-xs text-gray-300">
                Aadhaar biometric ID — <span className="text-red-400">No tokenisation increases fraud risk</span>
              </div>
            </div>
            ...
            <div className="bg-slate-800/60 p-4 rounded">
              ...
              <div className="text-xs text-gray-300">
                UPI — <span className="text-yellow-400">Works without Aadhaar, risks accumulate</span>
              </div>
            </div>
          ...
          <p className="mt-4 text-sm text-gray-300 bg-red-900/30 p-3 rounded border-l-4 border-red-500">
            ...
            7 million users’ Aadhaar numbers, device fingerprints, and bank details exposed.
          </p>
        </div>
        ...
        <div className="bg-slate-800/60 backdrop-blur border border-cyan-500/30 rounded-xl p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              <h4 className="font-semibold text-cyan-300 mb-2">NPCI Sees:</h4>
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                IMPS used Mobile Money Identifiers — NPCI had <span className="font-semibold text-green-400">no account visibility</span>.
                UPI makes surveillance easier and deeper.
              </p>
              <p className="text-xs mt-2 text-yellow-300 bg-yellow-900/20 p-2 rounded">
                Without tokenisation + strong privacy law, UPI enables unprecedented profiling.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-300">
            ...
            <div className="bg-slate-800/60 p-4 rounded">
              ...
              <ul className="space-y-2">
                ...
                <li>→ Public dashboards for performance</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-800/60 p-4 rounded">
              ...
              <ul className="space-y-2">
                <li>→ W3C/IETF-style standardisation</li>
                <li>→ Publish UPI specs</li>
                <li>→ FOSS reference apps</li>
                <li>→ Mandatory tokenisation</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-800/60 p-4 rounded">
              ...
              <ul className="space-y-2">
                ...
                <li>→ Promote NUE competitors</li>
                <li>→ User-funded account aggregators</li>
                <li>→ Explore Mojaloop federation</li>
              </ul>
            </div>
        ...
        <div className="bg-slate-800/60 backdrop-blur border border-blue-500/30 rounded-xl p-6 mb-8">
          ...
          <p className="text-sm text-gray-300 leading-relaxed">
            Britain tried to disrupt Germany’s economy by controlling global communication hubs.
            It failed due to technological limitations.  
            Today it is reversed:
            <span className="font-semibold text-red-300"> surveillance is easy</span>,  
            but
            <span className="font-semibold text-yellow-300"> sovereignty is hard</span>
            without open standards and transparent governance.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-base leading-relaxed mb-3">
                ...
                UPI succeeded at scale.  
                But Abraham argues sovereignty requires more than infrastructure:
                governance clarity, open standards, privacy safeguards, and sustainable incentives.
              </p>
