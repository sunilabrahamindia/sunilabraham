...
<div class="current-event-notice">
  📰 <strong>Current event:</strong> This article covers the India AI Impact Summit 2026, a current event. Information may be updated or changed rapidly as the event progresses.
</div>
...
/* Ashoka Chakra background - more subtle */
.banner-background {
  position: absolute;
  top: 50%;
  left: 50%;
