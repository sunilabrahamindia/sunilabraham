...
<div class="summit-banner">
  ...
  <div class="banner-content">
    ...
    <p class="banner-subtitle">16–20 February 2026 | Bharat Mandapam, New Delhi, India</p>
  </div>
</div>
...
<div class="tsap-info-box">
  ℹ️ <strong>About this section:</strong> On TSAP, we exclusively focus on Sunil Abraham's works and programmatic activities. This section contains information about Sunil Abraham's participation at the India AI Impact Summit 2026. As more details become available, this section is expected to move into a separate subpage: <a href='/events/india-ai-impact-summit-2026/sunil-abraham/'>Sunil Abraham at India AI Impact Summit 2026</a>.
</div>

Sunil Abraham, Public Policy Director at Meta, is scheduled to participate in two panel sessions during the India AI Impact Summit 2026.
...
.banner-background {
  ...
  width: 400px;
  height: 400px;
  background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><circle cx="100" cy="100" r="95" fill="none" stroke="%23000080" stroke-width="4" opacity="0.08"/><circle cx="100" cy="100" r="70" fill="none" stroke="%23000080" stroke-width="3" opacity="0.08"/><circle cx="100" cy="100" r="45" fill="none" stroke="%23000080" stroke-width="3" opacity="0.08"/><circle cx="100" cy="100" r="10" fill="%23000080" opacity="0.08"/></svg>');
