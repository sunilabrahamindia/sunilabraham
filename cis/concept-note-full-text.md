---
layout: default
title: "Full Text: Concept Note for the Centre for Internet and Society"
description: "Complete verbatim text of the founding concept note of the Centre for Internet and Society, prepared in July 2008."
...
The **full text of the [Concept Note for the Centre for Internet and Society](/cis/concept-note/)** is reproduced here verbatim from the original document, as prepared by the [Centre for Internet and Society](/cis/) in 2008.

{% assign img_path = "/cis/images/cis-concept-note-image.jpg" %}
<figure style="text-align: center; margin: 1.5rem auto; max-width: 600px;">
  <img src="{{ img_path | relative_url }}"
       alt="A notice board reading 'INTERNET →' and 'VEHICLES NOT ALLOWED', photographed in India circa 2008"
...
- [Background](#background)
  - [Growth and significance of the Internet](#growth-and-significance-of-the-internet)
  - [Enclosure and Push Back](#enclosure-and-push-back)
  - [India](#india)
- [Challenges with Internet Policies](#challenges-with-internet-policies)
- [The Centre for Internet and Society](#the-centre-for-internet-and-society)
  - [Mission](#mission)
  - [Objectives](#objectives)
  - [Setting a New Research Agenda](#setting-a-new-research-agenda)
  - [Potential Differences in Approach](#potential-differences-in-approach)
- [Internet and the Family](#internet-and-the-family)
- [IPR and Trade](#ipr-and-trade)
- [Activities](#activities)
- [Substantive Areas of Engagement](#substantive-areas-of-engagement)
  - [Celebrate](#celebrate)
  - [Criticise](#criticise)
  - [Research](#research)
- [Co-ordination with other Donors](#co-ordination-with-other-donors)
- [Immediate Opportunities for Policy Intervention](#immediate-opportunities-for-policy-intervention)
...
<ol type="a">
  <li>Develops conceptual tools, language and vocabulary of understanding the various ways in which ICTs inflect our registers of life</li>
  <li>Understand the nuances of the larger socio-political and cultural histories of technologies and their percolation in the Asian context</li>
  <li>Make larger connections of governmentality, globalisation, urbanisation and the way they alter the relationship between the state and the subject</li>
  <li>Provide new research that is not only grounded in empiricism and ethnography but also posits the centrality of technology to the various political and cultural concerns of our times in order to inform a more sensitive understanding of internet and cyberspace as well as intervene in the public debates around the same</li>
</ol>
