---
layout: default
title: "Privacy Concerns in Whole Body Imaging: A Few Questions"
description: "A CIS blog post by Elonnai Hickok examining whether Whole Body Imaging technology at airports can be reconciled with the right to privacy."
...
**"Privacy Concerns in Whole Body Imaging: A Few Questions"** is a blog post by [Elonnai Hickok](/elonnai/) published by the [Centre for Internet and Society](/cis/) on 17 November 2010. It examines whether Whole Body Imaging technology deployed at airports and elsewhere can be reconciled with an individual's right to privacy. Drawing on examples from the United States, the United Kingdom, the Netherlands, Germany, Canada, Nigeria, and the United Arab Emirates, Hickok argues that even if the Government of India ultimately favours tighter security measures, such measures must be balanced against concerns for personal freedom. She contends that privacy is not simply a matter of data protection, but something that must be assessed holistically and contextually.
...
<dl class="media-details">
  ...
  <dt>🔗 Original Link:</dt>
  <dd>
    <a href="https://cis-india.org/internet-governance/blog/privacy-concerns-in-whole-body-imaging-a-few-questions">Read the original post</a>
  </dd>
</dl>
...
<p>Security versus Privacy...it is a question that the world is facing today when it comes to using the Whole Body Imaging technology to screen a traveller visually in airports and other places. By giving real life examples from different parts of the world, Elonnai Hickok points out that even if the Government of India eventually decides to advocate the tight security measures with some restrictions then such measures need to be balanced against concerns raised for personal freedom. She further argues that privacy is not just data protection but something which must be viewed holistically and contextually when assessing new policies.</p>

<hr class="article-separator">

<h3>What is Whole Body Imaging?</h3>
...
<h3>How are These Technologies Being Used – Two News Items to Ponder</h3>
...
<h3>Questions at the Heart of the WBI Debate</h3>
...
<h3>How Have Other Countries Responded to Whole Body Imaging and How Should India Respond?</h3>
...
Published just weeks after the Netherlands began deploying scanners on Amsterdam-to-US flights and against the backdrop of the failed 2009 Detroit bomb plot, this post captures a moment when whole body imaging was moving from a niche security measure to a live policy question for India. Hickok's comparison across the United States, the United Kingdom, Germany, the Netherlands, Canada, Nigeria, and the United Arab Emirates illustrates how different countries weighed the same trade-off between security and privacy, with Dubai rejecting scanners on religious and privacy grounds while the United States expanded their use following the attempted Detroit attack.

The piece is notable for extending the privacy debate beyond fixed checkpoints to mobile backscatter x-ray vans, a use case that raised sharper questions of consent since drivers on public roads, unlike airport passengers, had not implicitly agreed to be screened by choosing to travel. Hickok's closing argument, that privacy cannot be reduced to data protection alone but must be assessed holistically and contextually, anticipated a framing that would recur throughout India's later debates over surveillance technology and biometric identification.

## External Link

- [Privacy Concerns in Whole Body Imaging: A Few Questions](https://cis-india.org/internet-governance/blog/privacy-concerns-in-whole-body-imaging-a-few-questions) on CIS website
