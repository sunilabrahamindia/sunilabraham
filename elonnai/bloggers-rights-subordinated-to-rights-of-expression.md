---
layout: default
title: "Bloggers' Rights Subordinated to Rights of Expression: Cyber Law Expert"
description: "A 2011 CIS e-mail interview by Elonnai Hickok with cyber law expert Na. Vijayashankar on bloggers' rights, online anonymity, cross-border jurisdiction, and intermediary liability under the IT Act rules."
...
**"Bloggers' Rights Subordinated to Rights of Expression: Cyber Law Expert"** is an e-mail interview conducted by [Elonnai Hickok](/elonnai/) with cyber law expert Na. Vijayashankar and published by the [Centre for Internet and Society](/cis/) on 3 June 2011. The piece explores the legal status of bloggers following the notification of the Information Technology (Intermediaries Guidelines) Rules in April 2011. The interview addresses freedom of expression, identity protection, cross-border jurisdictional challenges, law enforcement access requests, and the necessity of independent oversight mechanisms to protect online users.
...
<dl class="media-details">
  ...
  <dt>👤 Interviewee:</dt>
  <dd>Na. Vijayashankar</dd>

  <dt>📄 Type:</dt>
  <dd>E-mail interview</dd>

  <dt>🔗 Original Link:</dt>
  <dd>
    <a href="https://cis-india.org/internet-governance/blog/privacy/bloggers-rights-and-privacy">Read the original post</a>
  </dd>
</dl>
...
<p>Vijayashankar, an eminent cyber law expert answers Elonnai Hickok's questions on bloggers' rights, freedom of expression and privacy in this e-mail interview conducted on May 19, 2011.</p>

<hr class="article-separator">

<p>A set of rules relating to regulation of the Internet (mentioned in section 79 of the ITAA, 2008) was released in April 2011. In light of the rules framed under the IT Act, and as part of our research on privacy and Internet users, we have been looking into questions surrounding bloggers' rights, freedom of expression, and privacy.</p>
...
This interview was conducted in May 2011, shortly after India notified the Information Technology (Intermediaries Guidelines) Rules, 2011. The rules, framed under the Information Technology Act, 2000 as amended in 2008, introduced requirements governing the responsibilities of intermediaries in relation to content hosted or transmitted through their services. In the interview, Elonnai Hickok examines what these developments meant for bloggers and online users, particularly in relation to freedom of expression, privacy, anonymity, and intermediary liability.

The discussion begins by considering what should be understood by "bloggers' rights". Na. Vijayashankar distinguishes between the different roles a blogger may perform, including those of author, editor, and publisher. The interview considers the corresponding rights and responsibilities of bloggers, including the freedom to express opinions, the ability to maintain a degree of privacy and anonymity, and the responsibility for material that is deliberately made public. It also considers the tension between anonymity and accountability, particularly where published material may give rise to claims such as defamation.

A significant part of the discussion concerns the difficulty of applying national laws to material published on the Internet. A blogger may be located in one country while the material is read in many others, creating questions about which jurisdiction should apply and which country should have authority to seek information about the blogger. The interview considers both governmental and private requests for information and discusses the difficulties of obtaining information across national boundaries. It raises the possibility of an international mechanism or tribunal for addressing disputes involving bloggers and the cross-border application of legal standards.

The interview then turns to privacy violations affecting Internet users more generally. Examples discussed include phishing and identity theft, manipulation of social networking profiles, cybersquatting, the publication or alteration of photographs, and spam. For bloggers specifically, the interview places particular importance on protection of identity and the right to blog anonymously, while recognising that anonymity may have limits where published material gives law enforcement or others grounds for legal action.

Government access to online information is another major concern. The discussion refers to developments including the intermediary rules, requests for access to BlackBerry encryption keys, and reports of telephone wiretapping. Vijayashankar argues for a mechanism through which requests by law enforcement agencies for sensitive information could be examined, with safeguards against arbitrary or inappropriate access. The interview also considers the idea of a body with public representation that could provide an additional layer of scrutiny in disputes involving government requests, blocking of blogs, or access to private information.

Finally, the interview considers whether comprehensive privacy legislation could provide stronger protection for bloggers and other online users. Vijayashankar suggests that such legislation should recognise individual privacy rights as part of broader social interests and should take the interests of different stakeholders into account. The discussion therefore connects bloggers' freedom of expression, anonymity, privacy, intermediary responsibility, and government access to information as interconnected questions within India's emerging legal framework for the Internet.

## External Link

- [Bloggers' Rights Subordinated to Rights of Expression: Cyber Law Expert](https://cis-india.org/internet-governance/blog/privacy/bloggers-rights-and-privacy) on CIS website
