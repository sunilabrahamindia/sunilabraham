...
**"Does the UID Reflect India?"** is an event summary and analytical post by [Elonnai Hickok](/elonnai/) published by the [Centre for Internet and Society](/cis/) on 27 December 2010. It details the press conference and public meeting organized by the Campaign for No UID in Bangalore on 17 December 2010. The article examines arguments raised by activists and legal scholars, including Usha Ramanathan and Mathew Thomas, regarding the structural weaknesses of the Unique Identification (UID) Bill, its questionable legal validity, potential for biometric-based identity theft, and the threat of centralized surveillance.
...
<dl class="media-details">
  ...
  <dt>🔗 Original Link:</dt>
  <dd>
    <a href="https://cis-india.org/internet-governance/blog/privacy/uid-reflects-india">Read the original post</a>
  </dd>
</dl>
...
<p>On December 17th the Campaign for No UID held a press conference and public meeting in Bangalore. Below is a summary and analysis of the events.</p>
...
In late December 2010, public opposition to India's Unique Identification (UID) project began consolidating around legal, technical, and human rights concerns. Civil society groups, organized under collective banners such as the Campaign for No UID, convened public forums to scrutinize the socio-legal foundation of the initiative. Despite the National Identification Authority of India Bill, 2010 being referred to the Parliamentary Standing Committee on Finance for examination, enrolment had already begun across multiple states. Activists underscored the democratic irregularity of collecting sensitive biometrics from millions of residents prior to statutory approval by Parliament.

A central critique raised during these public assemblies focused on the disconnect between the marketing of the project and its operational design. Framed by proponents as an inclusive technological solution for social welfare leakage and poverty alleviation, critics pointed out that the statutory draft provided no explicit legal entitlement guaranteeing benefits or welfare delivery to marginalized populations. Instead, the broad statutory language enabled function creep, while the absence of explicit non-denial guarantees meant that possession of a 12-digit number rapidly became a de facto prerequisite for accessing fundamental state entitlements.

The technical reliance on biometric identification was similarly challenged on security and legal grounds. Because fingerprints and iris scans are inherently public markers that can be duplicated, critics argued that relying solely on biometrics created systemic vulnerabilities to identity theft. Furthermore, within a populace where digital literacy and legal access remain unevenly distributed, the burden of rectifying fraudulent enrolments or system failures fell disproportionately on vulnerable communities.

Finally, the analysis articulated deep concerns regarding centralized data aggregation and state surveillance. By linking a single persistent identifier to routine transactions, the UID structure altered the historical baseline of default anonymity within Indian society. In the absence of a comprehensive national data protection law, the creation of a centralized identification grid posed severe risks of pervasive population tracking, social sorting, and arbitrary executive overreach.

## External Link

- [Does the UID Reflect India?](https://cis-india.org/internet-governance/blog/privacy/uid-reflects-india) on CIS website
