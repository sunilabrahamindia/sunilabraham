...
**"American Bar Association Online Privacy Conference: A Report"** is a blog post by [Elonnai Hickok](/elonnai/) published by the [Centre for Internet and Society](/cis/) on 22 November 2010. It reports on an American Bar Association online conference titled "Regulating Privacy Across Borders in the Digital Age: An Emerging Global Consensus or Vive la Difference," held on 10 November 2010. Hickok summarises the panel's discussion of cloud computing, behavioural advertising, cross-border data transfer, privacy seals, accountability, and data breach notification, drawing out what each debate might mean as India considers its own privacy legislation.
...
<dl class="media-details">
  ...
  <dt>🔗 Original Link:</dt>
  <dd>
    <a href="https://cis-india.org/internet-governance/blog/privacy/privacy-aba-conference">Read the original post</a>
  </dd>
</dl>
...
<p>On 10 November 2010, I attended an American Bar Association online conference on "Regulating Privacy Across Borders in the Digital Age: An Emerging Global Consensus or Vive la Difference." The panellists addressed many important global privacy challenges and spoke about the changes the EU directive is looking to take.</p>
...
<ul>
<li>Lisa Sotto, a private practitioner in the US</li>
<li>Billy Hawkes, Commissioner of Data Protection, Ireland</li>
<li>Bojana Bellamy, Director of Data Privacy, London, UK</li>
<li>Hugh Stevenson, Deputy Director of the Federal Trade Commission, US</li>
<li>Jennifer Stoddart, Privacy Commissioner, Canada.</li>
</ul>
...
<ol>
<li>The type of information and compromised number of records</li>
<li>The circumstances of the loss, release, or corruption</li>
<li>Actions taken to minimize or mitigate the effect on individuals involved including whether they have been informed</li>
<li>Details of how the breach is being investigated</li>
<li>Whether any other regulatory bodies have been informed and, if so, their responses</li>
<li>Remedial actions taken to prevent future occurrences and any other information that may assist the ICO in making an assessment.</li>
</ol>
...
<ul>
<li>Does it want a broad legislation, one that could limit business and trade (unless potential trading partners demand such legislation), or sector-based legislations, which risk being too tailored and difficult to harmonize?</li>
<li>If India wants a broad privacy framework how will this be set up?</li>
<li>What will be the tools used for civil education?</li>
<li>How will enforcement take place?</li>
<li>Is self regulated accountability or statuary accountability better?</li>
<li>Will there be a privacy tribunal?</li>
<li>How will data be categorized?</li>
<li>Will breaches be notified?</li>
<li>Will standardized privacy policies be created?</li>
</ul>
...
This report captures a moment when the EU's Data Protection Directive was still being reworked toward what would eventually become the General Data Protection Regulation, with accountability, breach notification, and privacy-by-design already emerging as core pillars of that overhaul years before formal adoption. Hickok's attendance at an American Bar Association conference, rather than an Indian policy forum, reflects a deliberate strategy at CIS of tracking international regulatory developments and translating them into direct questions for India's own, then-nonexistent, privacy law.

The piece is particularly notable for identifying the "privacy seal" idea as a potential market-driven pressure point for India, reasoning that Indian consumption of American-made technology could indirectly push domestic manufacturers toward similar privacy standards even without local legislation, an argument that anticipated how international trade and technology dependencies would later shape India's regulatory choices. Hickok closes by naming the central tension India's eventual privacy law would have to resolve, between an ambitious, comprehensive framework and a workable, enforceable one, a question that persisted through several drafts of India's data protection legislation in the years that followed.
