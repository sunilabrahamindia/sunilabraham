...
2. [Frederick and the Freedom Continuum](#freedom-continuum)
3. [The Story of Frederick](#story)
4. [Frederick as a Lens for the Intellectual Property Regime](#ip-regime)
5. [Continuing the Thought Experiment](#thought-experiment)
...
<div class="pdf-container">
  ...
  <iframe
    ...
    class="pdf-frame"
    title="Freedom Continuum: From Access to Knowledge to Privacy"
    aria-label="Freedom Continuum Presentation Slides"
    loading="lazy">
  </iframe>

  <p class="pdf-note">
    If the PDF viewer does not load properly, please refresh the page or download the slides directly.
  </p>

  <p class="pdf-download">
    <a class="btn" href="https://raw.githubusercontent.com/sunilabrahamindia/sunilabrahammedia/main/sunil/freedom-continuum.pdf" download>
      📄 Download Presentation Slides (PDF)
    </a>
  </p>
</div>

## The Story of Frederick {#story}
...
<figure class="book-cover">
  <img
    src="https://raw.githubusercontent.com/sunilabrahamindia/sunilabrahammedia/main/sunil/frederick-book-cover.jpg"
    alt="Cover of Frederick by Leo Lionni"
    loading="lazy">
  <figcaption>Cover of <em>Frederick</em> by Leo Lionni.</figcaption>
</figure>
...
## Frederick as a Lens for the Intellectual Property Regime {#ip-regime}
...
## Continuing the Thought Experiment {#thought-experiment}
...
<!-- 5. Summer School presentation discussing *Frederick* (if and when publicly available). -->
