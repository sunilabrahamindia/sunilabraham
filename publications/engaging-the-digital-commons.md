...
<dl class="pub-details">
  <dt>👤 Authors:</dt>
  <dd>Pranesh Prakash &amp; Sunil Abraham</dd>

  <dt>🏛️ Published in:</dt>
  <dd><em>Common Voices</em>, Issue 4</dd>

  <dt>📅 Date:</dt>
  <dd>2011</dd>

  <dt>📘 Type:</dt>
  <dd>Journal Article (Conference Paper)</dd>

  <dt>📄 Access:</dt>
  <dd><a class="btn" href="/publications/files/engaging-the-digital-commons.pdf" download>Download PDF</a></dd>
</dl>
...
<div class="pdf-container">
  <iframe
    src="https://docs.google.com/gview?url=https://sunilabraham.in/publications/files/engaging-the-digital-commons.pdf&embedded=true"
    frameborder="0"
    class="pdf-frame"
  ...
  <p class="pdf-download">
    <a class="btn" href="/publications/files/engaging-the-digital-commons.pdf" download>
