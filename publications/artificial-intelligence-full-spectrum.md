...
<dl class="pub-details">
  <dt>👤 Authors:</dt>
  <dd>Sunil Abraham, Shweta Mohandas, Mira Swaminathan, and Shweta Reddy</dd>

  <dt>🏛️ Published by:</dt>
  <dd><em>The Centre for Internet and Society (CIS)</em></dd>

  <dt>📅 Date:</dt>
  <dd>1 October 2019</dd>

  <dt>📘 Type:</dt>
  <dd>Policy Brief / Regulatory Framework for Artificial Intelligence</dd>

  <dt>📄 Access:</dt>
  <dd><a class="btn" href="/publications/files/artificial-intelligence-full-spectrum.pdf" download>Download PDF</a></dd>
</dl>
...
<div class="pdf-container">
  <iframe
    src="https://docs.google.com/gview?url=https://sunilabraham.in/publications/files/artificial-intelligence-full-spectrum.pdf&embedded=true"
    frameborder="0"
    class="pdf-frame"
  ...
  <p class="pdf-download">
    <a class="btn" href="/publications/files/artificial-intelligence-full-spectrum.pdf" download>
...
**APA**
<pre><code>Abraham, S., Mohandas, S., Swaminathan, M., & Reddy, S. (2019).
...
**BibTeX**
<pre><code>@misc{abraham2019aispectrum,
...
**MLA**
<pre><code>Abraham, Sunil, Shweta Mohandas, Mira Swaminathan, and Shweta Reddy.
"Artificial Intelligence: A Full-Spectrum Regulatory Challenge."
