---
layout: default
title: "Freedom from Monitoring: India Inc Should Push For Privacy Laws"
description: "An opinion article by Sunil Abraham in Forbes India arguing that excessive surveillance undermines security and urging Indian industry to push for a comprehensive privacy law."
...
<div class="highlighted-text" id="fulltext">
  ...
  <p>Most people complaining online about projects like the Central Monitoring System seem to think that India has no privacy laws. This is completely untrue: We have around 50 different laws, rules and regulations that aim to uphold privacy and confidentiality in various domains. Unfortunately, most of those policies are very dated and do not sufficiently take into account the challenges of contemporary information societies. These policy documents need to be updated and harmonised through the enactment of a new horizontal privacy law. A small minority will say that Section 43(A) of the Information Technology Act is the India privacy law. That is not completely untrue, but is a gross exaggeration. Section 43(A) is really only a data security provision and, at that, it does not even comprehensively address data protection, which is only a sub-set of the overall privacy regulation required in a nation.</p>
...
Published in August 2013, this column responds to Indian government surveillance proposals such as NATGRID and the Central Monitoring System.  
Sunil Abraham argues industry should not be complacent: stronger privacy protections will support enterprise security, international trade (by aligning with EU requirements) and civil liberties. The piece draws on contemporary policy work such as the Justice A.P. Shah Committee report and the then-pending privacy bill drafting processes.

{% include back-to-top.html %}

## External Link

- [Read on Forbes India](https://www.forbesindia.com/article/recliner/freedom-from-monitoring-india-inc-should-push-for-privacy-laws/35911/1)
...
.media-details dt { font-weight: 600; color: #1b2a49; margin-top: 0.6rem; }
.media-details dd { margin: 0 0 0.4rem 0.4rem; color: #444; }
...
.copy-btn-full:hover { background: #e8e8e8; }
