...
<dl class="pub-details">
  <dt>👤 Authors:</dt>
  <dd>Sunil Abraham and Vidushi Marda, with inputs from Pranesh Prakash</dd>

  <dt>🏛️ Submitted by:</dt>
  <dd><em>The Centre for Internet and Society (CIS)</em></dd>

  <dt>📅 Date of Submission:</dt>
  <dd>15 December 2016</dd>

  <dt>📘 Type:</dt>
  <dd>Policy Brief / Formal Submission to the United Nations Working Group on Enhanced Cooperation (WGEC)</dd>
</dl>
...
.pub-details dt { font-weight: 600; color: #1b2a49; margin-top: 0.7rem; }
.pub-details dd { margin: 0 0 0.3rem 0.3rem; color: #555; }
</style>
...
- articulation of global principles by international and Internet institutions, and  
- creation of self-regulatory norms by the private sector and other stakeholders.  
...
- must enable governments to collaborate on *international* public policy (e.g. cross-border taxation, cybercrime, or hate speech),  
