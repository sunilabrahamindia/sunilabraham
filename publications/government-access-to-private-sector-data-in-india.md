...
description: "A detailed examination of how the Indian government obtains data from private entities through various legal, policy, and administrative mechanisms."
categories: [Publications]
date: 2012-12-01
authors: ["Sunil Abraham", "Elonnai Hickok"]
...
<dl class="pub-details">
  <dt>👤 Authors:</dt>
  <dd>Sunil Abraham and Elonnai Hickok</dd>

  <dt>🏛️ Published in:</dt>
  <dd><em>International Data Privacy Law</em> (Oxford University Press, Vol. 2, No. 4)</dd>

  <dt>📅 Date:</dt>
  <dd>2012</dd>

  <dt>📘 Type:</dt>
  <dd>Research Paper</dd>

  <dt>📄 Access:</dt>
  <dd><a class="btn" href="/publications/files/government-access-to-private-sector-data-in-india.pdf" download>Download PDF</a></dd>
</dl>
...
<div class="pdf-container">
  ...
  <iframe
    src="https://docs.google.com/gview?url=https://sunilabraham.in/publications/files/government-access-to-private-sector-data-in-india.pdf&embedded=true"
    frameborder="0"
    class="pdf-frame"
...
<a class="btn" href="/publications/files/government-access-to-private-sector-data-in-india.pdf" download>
...
/* copy button for citation blocks */
.copy-btn {
  position: absolute;
  top: 6px;
  right: 6px;
...
**APA style:**
<pre><code>Abraham, S., & Hickok, E. (2012).
...
**BibTeX style**
<pre><code>@article{abraham2012data,
...
**MLA style**
<pre><code>Abraham, Sunil, and Elonnai Hickok. "Government Access to Private-Sector Data in India."
