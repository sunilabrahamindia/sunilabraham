---
layout: default
title: "TV versus Social Media: The Rights and Wrongs"
description: "A Tribune guest column by Sunil Abraham (20 January 2013) discussing differences between broadcast regulation and social media, the 'principle of equivalence', anonymity, Aadhaar/UID debates, Section 66-A and regulatory implications for public and ordinary citizens."
...
<dl class="media-details">
  <dt>📰 Published in:</dt>
  <dd><em>The Tribune</em></dd>

  <dt>📅 Date:</dt>
  <dd>20 January 2013</dd>

  <dt>👤 Author:</dt>
  <dd>Sunil Abraham</dd>

  <dt>📄 Type:</dt>
  <dd>Guest Column / Opinion</dd>

  <dt>📰 Newspaper Link:</dt>
  <dd>
    <a class="btn" href="http://www.tribuneindia.com/2013/20130120/edit.htm#2">
      Read Online
    </a>
  </dd>
</dl>
...
This column argues that the "principle of equivalence" — treating social media and broadcast media as requiring identical regulation — is flawed. Sunil Abraham highlights differences in reach, attention asymmetries, and the public/private distinction, and cautions against policies that would overregulate ordinary citizens while failing to address the larger harms arising from influential public actors. The piece also discusses threats to anonymous speech and the risks of identity-tagging proposals (for example, linking social media activity to UID/Aadhaar), and reflects on how such measures could chill democratic discourse.
