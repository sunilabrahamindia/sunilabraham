---
layout: default
title: "Wherever You Are, Whatever You Do"
description: "An Indian Express column by Sunil Abraham about location services, geo-surveillance, and privacy concerns following Facebook Places' launch."
...
**Wherever You Are, Whatever You Do** is a newspaper column by Sunil Abraham published in *Indian Express* on 23 August 2010. The article examines Facebook's launch of the location-based service Places and uses it to highlight wider concerns around geo-location tracking in India. [Sunil Abraham](/sunil/) contrasts telecom-based location logs, GPS systems and social networking platforms, and explains how weak privacy safeguards and intrusive defaults can expose citizens to profiling, surveillance, stalking and misuse.
...
This column examines privacy concerns raised by Facebook Places and situates them in India's broader regulatory context. Abraham explains the technical differences between telecom-based location, GPS, and their social implications, and outlines three reasons why Facebook's Places triggered particular alarm among privacy advocates despite existing geo-location practices by telecom operators.
