...
description: "An examination of the state's dual responsibility to expand Internet access while safeguarding freedom of expression in the Global South."
categories: [Book chapters, Publications]
date: 2018-01-01
authors: ["Sunil Abraham"]
book: "Just Security in an Undergoverned World"
editors: ["William J. Durch", "Joris Larik", "Richard Ponzio"]
...
<dl class="pub-details">
  <dt>👤 Author:</dt><dd>Sunil Abraham</dd>

  <dt>📘 In Book:</dt><dd><em>Just Security in an Undergoverned World</em></dd>

  <dt>📚 Editors:</dt><dd>William J. Durch; Joris Larik; Richard Ponzio</dd>

  <dt>🏛️ Publisher:</dt><dd>Oxford University Press</dd>

  <dt>📅 Year:</dt><dd>2018</dd>

  <dt>🔢 ISBN:</dt><dd>978-0-19-880537-3</dd>

  <dt>📄 Pages:</dt><dd>pp. 352–388</dd>

  <dt>📘 Type:</dt><dd>Book Chapter</dd>

  <dt>📄 Access:</dt><dd><a class="btn" href="/publications/files/first-among-equals.pdf" download>Download PDF</a></dd>
</dl>
...
<div class="pdf-container">
  <iframe
    src="https://docs.google.com/gview?url=https://sunilabraham.in/publications/files/first-among-equals.pdf&embedded=true"
    frameborder="0"
    class="pdf-frame"
  ...
  <p class="pdf-download">
    <a class="btn" href="/publications/files/first-among-equals.pdf" download>
...
.pdf-frame { width: 100%; height: 80vh; border: 1px solid #ccc; border-radius: 8px; }
