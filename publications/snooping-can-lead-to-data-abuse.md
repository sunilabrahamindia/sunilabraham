---
layout: default
title: "Snooping Can Lead to Data Abuse"
description: "A Mail Today article by Sunil Abraham analysing NATGRID, blanket surveillance, national security risks, and the dangers of merging 21 government databases."
...
**Snooping Can Lead to Data Abuse** is an article by [Sunil Abraham](/sunil/) published in *Mail Today* on 9 June 2011. It critiques NATGRID's blanket-surveillance design and argues that merging 21 government databases undermines, rather than strengthens, national security.
...
<dl class="media-details">
  ...
  <dt>📄 PDF Access:</dt>
  <dd>
    <a class="btn" href="/publications/files/snooping-can-lead-to-data-abuse.pdf" download>
      Download PDF (Original epaper)
    </a>
  </dd>
...
<p>The writer is executive director at the Centre for Internet and Society in Bangalore. (As told to Max Martin)</p>
...
<div class="pdf-container">
  <iframe
    src="https://docs.google.com/gview?url=https://sunilabraham.in/publications/files/snooping-can-lead-to-data-abuse.pdf&embedded=true"
    frameborder="0"
    class="pdf-frame"
...
This column evaluates the NATGRID surveillance architecture and argues that merging 21 sensitive databases into a single system creates a catastrophic security risk. Sunil Abraham highlights the absence of essential privacy safeguards, breach notifications and data-access rights that are standard in democracies with stronger privacy laws. He warns that blanket surveillance distracts investigators, enables abuse and serves more as a tool of citizen intimidation than national security.
