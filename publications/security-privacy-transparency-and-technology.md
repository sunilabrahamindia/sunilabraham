...
description: "Explores the tensions between privacy rights, transparency, and technological security in governance, analysing how policy and institutional frameworks can reconcile these competing objectives."
categories: [Publications]
date: 2015-10-01
authors: ["Sunil Abraham", "Elonnai Hickok", "Tarun Krishnakumar"]
...
<dl class="pub-details">
  <dt>👤 Authors:</dt>
  <dd>Sunil Abraham, Elonnai Hickok, and Tarun Krishnakumar</dd>

  <dt>🏛️ Published in:</dt>
  <dd><em>Digital Debates 2015: CyFy Journal, Volume 2, Observer Research Foundation</em></dd>
  ...
  <dt>📄 Access:</dt>
  <dd><a class="btn" href="/publications/files/security-privacy-transparency-and-technology.pdf" download>Download PDF</a></dd>
</dl>
...
<div class="pdf-container">
  <iframe
    src="https://docs.google.com/gview?url=https://sunilabraham.in/publications/files/security-privacy-transparency-and-technology.pdf&embedded=true"
    frameborder="0"
    class="pdf-frame"
  ...
  <p class="pdf-download">
    <a class="btn" href="/publications/files/security-privacy-transparency-and-technology.pdf" download>
