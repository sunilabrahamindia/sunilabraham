---
layout: default
title: "The Church and the Study of Religion"
...
<ol>
  <li id="note-1">
    Saral K. Chatterji, 'Some ingredients of a Theology of the People,' <em>Religion and Society</em>, Vol. XXVII, No. 4, Dec. 1980.
    <a href="#ref-1">↩</a>
  </li>

  <li id="note-2">
    Statement of the Indian preparatory meet for the 1981 EATWT Assembly.
    <a href="#ref-2">↩</a>
  </li>

  <li id="note-3">
    The eldest member will be the <em>ex jure</em> king.
    <a href="#ref-3">↩</a>
  </li>

  <li id="note-4">
    Giulio Girardi, quoted by Lalit Uniyal, 'Hindu-Muslim problem, A Strategy for Change', <em>Indian Express</em>, April 27, 1979.
    <a href="#ref-4">↩</a>
  </li>

  <li id="note-5">
    Cf. CCA-URM, CISRS literature.
    <a href="#ref-5">↩</a>
  </li>

  <li id="note-6">
    Saral K. Chatterji, <em>op. cit.</em>, p. 24.
    <a href="#ref-6">↩</a>
  </li>
</ol>
