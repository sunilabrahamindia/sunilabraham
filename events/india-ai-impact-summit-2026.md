...
description: "Analysis of the India AI Impact Summit 2026 in New Delhi, documenting outcome documents from global AI summits (2023-2026) and quantitative policy evolution from safety-focused to openness-oriented governance."
authors: ["Tito Dutta"]
categories: [AI Impact Summit 2026, Artificial Intelligence, Events]
date: 2026-02-16
...
<div class="table-title">Global AI Summits: The Journey So Far</div>
...
<div class="outcome-doc-card">
  ...
  <div class="outcome-doc-links">
    ...
    <a href="https://assets.publishing.service.gov.uk/media/6544ec4259b9f5001385a220/aiss-statement-on-safety-testing-outcomes.pdf" class="outcome-doc-link-alt">🔗 Official source</a>
  </div>
</div>
...
<div class="outcome-doc-card">
  ...
  <div class="outcome-doc-links">
    ...
    <a href="https://www.gov.uk/government/publications/seoul-declaration-for-safe-innovative-and-inclusive-ai-ai-seoul-summit-2024" class="outcome-doc-link-alt">🔗 Official source</a>
  </div>
  <div class="outcome-doc-commitments">
    <strong>Key commitments:</strong>
    <ul>
      <li>Balance between AI safety and continued innovation</li>
      <li>Support for inclusive AI development bridging digital divides</li>
      <li>International cooperation linking various global AI safety initiatives</li>
      <li>Recognition that safety frameworks must accommodate diverse economic contexts</li>
    </ul>
  </div>
</div>
...
<div class="outcome-doc-card">
  ...
  <div class="outcome-doc-links">
    ...
    <a href="https://www.gov.uk/government/publications/seoul-declaration-for-safe-innovative-and-inclusive-ai-ai-seoul-summit-2024/seoul-statement-of-intent-toward-international-cooperation-on-ai-safety-science-ai-seoul-summit-2024-annex" class="outcome-doc-link-alt">🔗 Official source</a>
  </div>
</div>
...
<div class="outcome-doc-card">
  ...
  <div class="outcome-doc-links">
    ...
    <a href="https://www.gov.uk/government/publications/frontier-ai-safety-commitments-ai-seoul-summit-2024" class="outcome-doc-link-alt">🔗 Official source</a>
  </div>
  <div class="outcome-doc-commitments">
    <strong>Key commitments:</strong>
    <ul>
      <li>Define thresholds for intolerable AI risks and assess whether models breach them</li>
      <li>Conduct rigorous pre- and post-deployment safety testing</li>
      <li>Implement robust security controls for unreleased model weights</li>
      <li>Commit not to deploy models if risks cannot be adequately mitigated</li>
      <li>Maintain public transparency on safety frameworks and accountability measures</li>
    </ul>
  </div>
</div>
...
1. ['India-AI Impact Summit' to focus on 7 Chakras for policy and real-world applications](https://www.indiatribune.com/india-ai-impact-summit-to-focus-on-7-chakras-for-policy-and-real-world-applications), India Tribune, accessed 13 February 2026
2. [AI Impact Summit in Delhi: What to know — dates, venue, security, traffic, and global business leaders](https://timesofindia.indiatimes.com/city/delhi/ai-impact-summit-in-delhi-what-to-know-dates-venue-security-traffic-and-global-bu...), Times of India, accessed 13 February 2026
3. [About Summit - India AI Impact Summit 2026](https://impact.indiaai.gov.in/about-summit), IndiaAI Mission, Government of India, accessed 13 February 2026
4. [As a part of the India AI Impact Summit 2026](https://www.linkedin.com/posts/factlyindia_as-a-part-of-the-india-ai-impact-summit-2026-activity-7426956130314244096-pqED), Factly (LinkedIn), accessed 13 February 2026
5. [India AI Impact Summit 2026](https://impact.indiaai.gov.in), IndiaAI Mission, Government of India, accessed 13 February 2026
6. [India AI Impact Summit from 19-20 February 2026 in New Delhi](https://www.indianembassynetherlands.gov.in/section/news/india-ai-impact-summit-from-19-20-february-2026-in-new-delhi/), Indian Embassy, Netherlands, accessed 13 February 2026
7. [India is organising the AI Impact Summit 2026 on 19–20 February](https://x.com/cgihou/status/1989106707834843427), Consulate General of India (X/Twitter), accessed 13 February 2026
8. [India-AI Impact Summit 2026 reflects India's growing role in global AI discussions](https://www.pib.gov.in/PressReleaseIframePage.aspx?PRID=2220978), Press Information Bureau, Government of India, accessed 13 February 2026
9. [Sessions & Seminars - India AI Impact Summit 2026](https://impact.indiaai.gov.in/sessions?date=2026-02-20&s=Sunil+Abraham), IndiaAI Mission, Government of India, accessed 13 February 2026
...
/* Table title styling */
.summit-table-wrapper .table-title {
  font-size: 1rem;
  font-weight: 600;
  padding: 0.75rem;
  background: #495057;
...
.summit-table-wrapper table tr:last-child td {
  border-bottom: none;
}

/* Highlight current summit */
.summit-table-wrapper table tr:last-child {
  font-weight: 600;
  background: #fff3cd;
}

/* Column widths for better layout */
.summit-table-wrapper table th:nth-child(1),
.summit-table-wrapper table td:nth-child(1) {
  width: 18%;
}

.summit-table-wrapper table th:nth-child(2),
.summit-table-wrapper table td:nth-child(2) {
  width: 12%;
  white-space: nowrap;
}

.summit-table-wrapper table th:nth-child(3),
.summit-table-wrapper table td:nth-child(3) {
  width: 15%;
  white-space: nowrap;
}

.summit-table-wrapper table th:nth-child(4),
.summit-table-wrapper table td:nth-child(4) {
  width: 18%;
}

.summit-table-wrapper table th:nth-child(5),
.summit-table-wrapper table td:nth-child(5) {
  width: 37%;
}
...
/* Mobile: center align and simplify */
@media (max-width: 768px) {
  .summit-table-wrapper {
    float: none;
    margin: 1.5rem auto;
  ...
  /* Hide Participants column on mobile to prevent cramping */
  .summit-table-wrapper table th:nth-child(4),
  .summit-table-wrapper table td:nth-child(4) {
    display: none;
  }
...
@media (max-width: 480px) {
  ...
  /* Also hide Key Outcome on very small screens */
  .summit-table-wrapper table th:nth-child(5),
  .summit-table-wrapper table td:nth-child(5) {
    display: none;
  }
...
.banner-background {
  ...
  width: 500px;
  height: 500px;
  background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><circle cx="100" cy="100" r="95" fill="none" stroke="%23ffffff" stroke-width="2" opacity="0.05"/><circle cx="100" cy="100" r="70" fill="none" stroke="%23ffffff" stroke-width="2" opacity="0.05"/><circle cx="100" cy="100" r="45" fill="none" stroke="%23ffffff" stroke-width="2" opacity="0.05"/><circle cx="100" cy="100" r="8" fill="%23ffffff" opacity="0.05"/></svg>');
...
.outcome-doc-link, .outcome-doc-link-alt {
...
.outcome-doc-commitments ul {
  margin: 0.5rem 0 0 0;
  padding-left: 1.5rem;
}

.outcome-doc-commitments li {
  margin: 0.4rem 0;
  line-height: 1.5;
}
