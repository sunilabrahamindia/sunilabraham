...
For software, technologies, workflows, methodologies, and ideas that have been explored, tested, or studied but are not necessarily part of regular project operations, see the [Learning Log](/tsap/learning/).
...
## Browser (Computer) {#browser-computer}
...
Domain registration information may be viewed through the [public WHOIS record](https://www.whois.com/whois/sunilabraham.in)
...
{% include notice.html message="Sunil Abraham is considering the future use of Raspberry Pi devices as part of TSAP workflows. No Raspberry Pi systems are currently in active use within the project." %}
