...
- Provide historical and biographical context  
- Support and enrich written narratives  
- Document relationships, events, and environments  
- Preserve visual memory that may not exist elsewhere  
...
- Gradual enrichment of contextual information  
- Consistent referencing across the site  

### Structural Approach

The system follows a clear separation between storage and interpretation.

- Photographs are stored in a dedicated repository as a stable archive  
- The main project repository maintains descriptive and contextual information  
- Images are referenced by filename, without altering original file names  
...
- Within articles where they provide relevant context  
- Alongside publications, media mentions, and events  
- As supporting material in biographical and institutional documentation  
...
- Stability of stored files  
- Flexibility in descriptive data  
