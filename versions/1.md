---
layout: default
title: Version 1 Archive
categories: [Project pages, Versions]
description: "Archived version logs of the Sunil Abraham Project website, organised by major release cycles."
permalink: /versions/1/
created: 2026-02-22
---

**Version 1 Archive** preserves the foundational release cycle of the Sunil Abraham Project (TSAP), spanning Version 0.1 to the Version 1.0 milestone.  

The cycle marks the establishment of core site architecture, structured publication templates, media clustering systems, and long-term documentation standards.

Current progress details are available on the main [**Versions**](/versions/) page.
